...
public class RobotModel extends AnimatedEntityModel<RobotEntity> {
	...
	public RobotModel()
	{
		...
		body.setTextureOffset(20, 20).addBox(-4.0F, -6.0F, -2.0F, 8.0F, 12.0F, 4.0F, 0.0F);
		...
		body.addChild(key);
		key.setTextureOffset(0, 32).addBox(0.0F, -5.5F, 0.0F, 0.0F, 11.0F, 11.0F, 0.0F);
		...
		body.addChild(lleg);
		lleg.setTextureOffset(24, 36).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 5.0F, 2.0F, 0.0F);
		lleg.setTextureOffset(29, 0).addBox(-1.5F, 5.0F, -3.5F, 3.0F, 1.0F, 5.0F, 0.0F);
		...
		body.addChild(rleg);
		rleg.setTextureOffset(16, 36).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 5.0F, 2.0F, 0.0F);
		rleg.setTextureOffset(0, 26).addBox(-1.5F, 5.0F, -3.5F, 3.0F, 1.0F, 5.0F, 0.0F);
		...
		body.addChild(larm);
		larm.setTextureOffset(8, 32).addBox(0.0F, -1.0F, -1.0F, 2.0F, 8.0F, 2.0F, 0.0F);
		larm.setTextureOffset(36, 6).addBox(0.5F, 7.0F, -1.5F, 1.0F, 2.0F, 3.0F, 0.0F);
		...
		body.addChild(rarm);
		rarm.setTextureOffset(0, 32).addBox(-2.0F, -1.0F, -1.0F, 2.0F, 8.0F, 2.0F, 0.0F);
		rarm.setTextureOffset(11, 26).addBox(-1.5F, 7.0F, -1.5F, 1.0F, 2.0F, 3.0F, 0.0F);
		...
		body.addChild(head);
		head.setTextureOffset(0, 0).addBox(-5.5F, -9.0F, -3.5F, 11.0F, 9.0F, 7.0F, 0.0F);
		head.setTextureOffset(32, 36).addBox(5.5F, -6.0F, -1.5F, 1.0F, 3.0F, 3.0F, 0.0F);
		head.setTextureOffset(33, 13).addBox(-6.5F, -6.0F, -1.5F, 1.0F, 3.0F, 3.0F, 0.0F);
