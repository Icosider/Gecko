...
public class StingrayModel extends AnimatedEntityModel<StingrayTestEntity>
{
	...
	public StingrayModel()
	{
		...
		Stingray.setTextureOffset(6, 6).addBox(1.0F, -5.0F, -19.0F, 2.0F, 1.0F, 2.0F, 0.0F);
		Stingray.setTextureOffset(0, 4).addBox(-7.0F, -5.0F, -19.0F, 2.0F, 1.0F, 2.0F, 0.0F);
		Stingray.setModelRendererName("Stingray");

		Body = new AnimatedModelRenderer(this);
		Body.setRotationPoint(-2.0F, 0.0F, -12.0F);
		Stingray.addChild(Body);
		Body.setTextureOffset(70, 41).addBox(-4.0F, -2.0F, -8.0F, 8.0F, 2.0F, 16.0F, 0.0F);
		Body.setTextureOffset(0, 36).addBox(-5.0F, -4.0F, -8.0F, 10.0F, 2.0F, 16.0F, 0.0F);
		Body.setTextureOffset(50, 18).addBox(-7.0F, -3.0F, -10.0F, 14.0F, 2.0F, 2.0F, 0.0F);
		...
		mouth.setTextureOffset(50, 22).addBox(-2.0F, -2.2251F, -2.6648F, 4.0F, 1.0F, 1.0F, 0.0F);
		...
		Lefthand.setTextureOffset(4, 18).addBox(-13.0F, -1.25F, -8.0F, 13.0F, 2.0F, 16.0F, 0.0F);
		...
		smallfinleft.setTextureOffset(50, 0).addBox(-5.0F, -2.0F, -6.0F, 4.0F, 2.0F, 12.0F, 0.0F);
		...
		Righthand.setTextureOffset(4, 0).addBox(0.0F, -1.25F, -8.0F, 13.0F, 2.0F, 16.0F, 0.0F);
		...
		smallfinright.setTextureOffset(38, 38).addBox(0.0F, -2.0F, -6.0F, 4.0F, 2.0F, 12.0F, 0.0F);
		...
		Tail.addChild(tail1);
		tail1.setTextureOffset(20, 54).addBox(-3.0F, -4.0F, 1.0F, 4.0F, 4.0F, 6.0F, 0.0F);
		...
		bone.setTextureOffset(34, 58).addBox(-2.1057F, -2.0234F, 0.25F, 4.0F, 4.0F, 6.0F, 0.0F);
		...
		AllExcept12.setTextureOffset(0, 54).addBox(-2.1726F, -2.0937F, 0.25F, 4.0F, 4.0F, 6.0F, 0.0F);
		...
		AllExcept123.setTextureOffset(48, 52).addBox(-2.1726F, -2.3437F, 0.0F, 4.0F, 4.0F, 6.0F, 0.0F);
		AllExcept123.setTextureOffset(11, 80).addBox(-0.75F, -1.25F, 6.0F, 2.0F, 2.0F, 6.0F, 0.0F);
