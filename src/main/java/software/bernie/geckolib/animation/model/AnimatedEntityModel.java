...
public abstract class AnimatedEntityModel<T extends EntityLivingBase & IAnimatedEntity> extends ModelBase implements IResourceManagerReloadListener
{
	...
	private final List<AnimatedModelRenderer> modelRendererList = new ArrayList<>();
	private final HashMap<String, Animation> animationList = new HashMap<>();
	...
	public void onResourceManagerReload(IResourceManager resourceManager)
	{
		try
		{
			...
			Reader reader = new BufferedReader(
					stream);
			JsonObject jsonobject = fromJson(GSON, reader, JsonObject.class);
